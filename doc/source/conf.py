...
import os
import sys
sys.path.insert(0, os.path.abspath('../b2'))
...
man_pages = [
    (master_doc, 'b2_command_line_tool', u'B2_Command_Line_Tool Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'B2_Command_Line_Tool', u'B2_Command_Line_Tool Documentation',
     author, 'B2_Command_Line_Tool', 'One line description of project.',
     'Miscellaneous'),
]
