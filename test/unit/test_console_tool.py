...
class TestConsoleTool(BaseConsoleToolTest):
    ...
    def test_camel_case_supported_in_v3(self):
        self._authorize_account()
        self._run_command(
            ['create-bucket', 'my-bucket', '--bucket-info', '{"xxx": "123"}', 'allPrivate'],
            'bucket_0\n', '', 0
        )
        self._run_command(
    ...
    def test_camel_case_not_supported_in_v4(self):
        self._authorize_account()
        self._run_command(['create-bucket', 'my-bucket', '--bucket-info', 'allPrivate'], '', '', 2)
        self._run_command(
            ['create-bucket', 'my-bucket-kebab', '--bucket-info', '{"xxx": "123"}', 'allPrivate'],
            'bucket_0\n', '', 0
        )
    ...
    def test_escape_c0_char_on_sync_stack_trace(self):
        ...
        with TempDir() as temp_dir:
            ...
            self._run_command(
                [
                    'sync', '--no-progress', '--no-escape-control-characters', temp_dir,
                    'b2://my-bucket-0'
                ],
            ...
            self._run_command(
                [
                    'sync', '--no-progress', '--escape-control-characters', temp_dir,
                    'b2://my-bucket-1'
                ],
