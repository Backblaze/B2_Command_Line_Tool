...
class TestRm(TestCaseWithBucket):
    def test_rm_by_name_glob(self):
        ...
        for _ in self.bucket.glob_rm(False, False, ['test_rm*.txt']):
            pass
        expected = []
        self.assertBucketContents(expected, '', show_versions=True)
    ...
    def test_rm_by_name_regex(self):
        ...
        for _ in self.bucket.regex_rm(False, False, '', ['test_rm_2.txt']):
            pass
        expected = []
        self.assertBucketContents(expected, '', show_versions=True)
    ...
    def test_rm_by_glob_pattern(self):
        ...
        for _ in self.bucket.glob_rm(False, False, ['*.txt']):
            pass
        expected = []
        self.assertBucketContents(expected, '', show_versions=True)
    ...
    def test_rm_by_regex_pattern(self):
        ...
        for _ in self.bucket.regex_rm(False, False, '', ['test_rm_[56].txt']):
            pass
        expected = []
        self.assertBucketContents(expected, '', show_versions=True)

    def test_rm_by_multi_glob(self):
        data = six.b('hello world')
        ...
        for _ in self.bucket.glob_rm(False, False, ['*9.txt', '*10.txt']):
            pass
        expected = [('test_rm_11.txt', 11, 'upload', None)]
        self.assertBucketContents(expected, '', show_versions=True)

    def test_rm_by_multi_regex(self):
        data = six.b('hello world')
        ...
        for _ in self.bucket.regex_rm(False, False, '', ['.*12.txt', '.*13.txt']):
            pass
    ...
    def test_rm_without_versions(self):
        ...
        self.bucket.upload_bytes(data, 'test_rm_15.txt')
        for _ in self.bucket.glob_rm(False, False, ['test_rm_15.txt']):
            pass
    ...
    def test_rm_with_versions(self):
        ...
        self.bucket.upload_bytes(data, 'test_rm_16.txt')
        for _ in self.bucket.glob_rm(True, False, ['test_rm_16.txt']):
            pass
        expected = []
        self.assertBucketContents(expected, '', show_versions=True)
